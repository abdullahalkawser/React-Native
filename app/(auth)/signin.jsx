...
const Signin = () => {
  ...
  return (
    <SafeAreaView className='flex-1 bg-slate-900 p-5' >
      ...
      <Text className="text-white text-3xl font-bold text-center mb-8">Login </Text>
      ...
      <View className="flex-row justify-center mt-4">
        <Text className="text-white text-xl">Don't you have an account?</Text>
        <TouchableOpacity onPress={() => router.push('/signUp')}>
          <Text className="text-yellow-500 ml-2 text-xl">Create Acount</Text>
        </TouchableOpacity>
      </View>
